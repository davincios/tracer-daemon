...
pub static ref OPT_CONDA_BIN_EXCEPTIONS : Vec<TargetMatch> = vec![
    TargetMatch::ProcessName("[".to_string()),
    TargetMatch::ProcessName("awk".to_string()),
    TargetMatch::ProcessName("tee".to_string()),
    TargetMatch::ProcessName("printf".to_string()),
    TargetMatch::ProcessName("basename".to_string()),
    TargetMatch::ProcessName("pwd".to_string()),
    TargetMatch::ProcessName("realpath".to_string()),
    TargetMatch::ProcessName("rm".to_string()),
    TargetMatch::ProcessName("rmdir".to_string()),
    TargetMatch::ProcessName("chown".to_string()),
    TargetMatch::ProcessName("chgrp".to_string()),
    TargetMatch::ProcessName("chmod".to_string()),
    TargetMatch::ProcessName("clear".to_string()),
    TargetMatch::ProcessName("cp".to_string()),
    TargetMatch::ProcessName("cut".to_string()),
    TargetMatch::ProcessName("date".to_string()),
    TargetMatch::ProcessName("df".to_string()),
    TargetMatch::ProcessName("dir".to_string()),
    TargetMatch::ProcessName("dd".to_string()),
    TargetMatch::ProcessName("kill".to_string()),
    TargetMatch::ProcessName("sort".to_string()),
    TargetMatch::ProcessName("echo".to_string()),
    TargetMatch::ProcessName("env".to_string()),
    TargetMatch::ProcessName("stat".to_string()),
    TargetMatch::ProcessName("expr".to_string()),
    TargetMatch::ProcessName("tail".to_string()),
    TargetMatch::ProcessName("head".to_string()),
    TargetMatch::ProcessName("false".to_string()),
    TargetMatch::ProcessName("true".to_string()),
    TargetMatch::ProcessName("truncate".to_string()),
    TargetMatch::ProcessName("touch".to_string()),
    TargetMatch::ProcessName("mv".to_string()),
    TargetMatch::ProcessName("uname".to_string()),
    TargetMatch::ProcessName("wc".to_string()),
    TargetMatch::ProcessName("whoami".to_string()),
    TargetMatch::ProcessName("who".to_string()),
    TargetMatch::ProcessName("yes".to_string()),
    TargetMatch::ProcessName("find".to_string()),
    TargetMatch::ProcessName("grep".to_string()),
